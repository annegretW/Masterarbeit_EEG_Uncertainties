...
/* begin private */
/* Name of package */
#define PACKAGE "duneuro-py"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "andreas.nuessing@uni-muenster.de"

/* Define to the full name of this package. */
#define PACKAGE_NAME "duneuro-py"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "duneuro-py 2.5-dev"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "duneuro-py"
...
#define DUNEURO_PY_VERSION "2.5-dev"

/* Define to the major version of duneuro-py */
#define DUNEURO_PY_VERSION_MAJOR 2

/* Define to the minor version of duneuro-py */
#define DUNEURO_PY_VERSION_MINOR 5

/* Define to the revision of duneuro-py */
#define DUNEURO_PY_VERSION_REVISION 0
